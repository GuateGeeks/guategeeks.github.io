...
function Hero() {
  ...
  return (
    <section
      id="inicio"
      className="min-h-screen flex items-center overflow-hidden pt-24"
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(239, 133, 86, 0.4), transparent 70%)",
            top: "-10%",
            right: "-10%",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(104, 85, 153, 0.4), transparent 70%)",
            bottom: "-15%",
            left: "-10%",
            animationDelay: "2s",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(95, 186, 214, 0.3), transparent 70%)",
            top: "40%",
            left: "30%",
            animationDelay: "4s",
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Text Content */}
          <div
            className={`text-center lg:text-left transition-all duration-1000 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            {/* Badge */}
            <div
            ...
            >
              ...
              <span className="text-sm font-medium text-[var(--text-secondary)]">
                Innovación educativa en Guatemala
              </span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.05]">
              <span className="text-gradient-coral text-3xl sm:text-4xl md:text-5xl font-bold">
                Construimos
              </span>
              &thinsp;
              <span className="text-[var(--text-primary)] text-2xl sm:text-3xl md:text-4xl font-semibold opacity-90">
                junto a tu institución 
              </span>
              &thinsp;
              <span className="text-gradient-coral text-3xl sm:text-4xl md:text-5xl font-bold">
            ...
            <p className="mt-6 text-lg sm:text-xl text-[var(--text-secondary)] max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Programas educativos con Inteligencia Artificial, Robótica y
              tecnologías emergentes, integrados con metodologías STEAM y
              acompañamiento docente.
            </p>

            <p className="mt-4 text-sm sm:text-base text-[var(--text-tertiary)] max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Modalidades flexibles desde 2 meses, adaptadas a las necesidades
              de tu institución.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-6 justify-center lg:justify-start">
              {[
                ...
                <div key={i} className="text-center">
                  <div className="text-2xl font-bold text-gradient-coral">
                    {stat.number}
                  </div>
                  <div className="text-xs text-[var(--text-tertiary)] font-medium uppercase tracking-wide">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          <div
            className={`relative transition-all duration-1000 delay-300 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
          >
            <div className="relative w-full aspect-square max-w-lg mx-auto">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, rgba(239, 133, 86, 0.3), rgba(239, 133, 86, 0.05))",
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, rgba(95, 186, 214, 0.3), rgba(95, 186, 214, 0.05))",
                  backdropFilter: "blur(10px)",
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, rgba(104, 85, 153, 0.3), rgba(104, 85, 153, 0.05))",
                  backdropFilter: "blur(10px)",
