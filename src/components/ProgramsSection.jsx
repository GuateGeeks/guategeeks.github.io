  ...
  const programs = [
    {
      ...
      subtitle: "Validacion inicial",
      accentColor: "#3a8fa8",
      accentColorLight: "#5fbad6",
      accentGlow:
        "radial-gradient(circle, rgba(95, 186, 214, 0.15), transparent 70%)",
      features: [
        "Explora la integracion tecnologica en una implementacion corta",
        "Acompanamiento inicial para validar resultados",
        "Diagnostico base y plan de siguiente fase",
        "Experiencias practicas para mostrar impacto temprano",
        "Recomendaciones para escalar con menor riesgo",
      ],
    },
    {
      title: "Programa Integral Anual",
      ...
      recommended: true,
      features: [
        "Laboratorio permanente con integracion curricular STEAM",
        "Capacitacion docente y acompanamiento sostenido",
        "Planificacion academica para todo el ciclo escolar",
        "Medicion de impacto y mejora continua",
        "Escalamiento institucional con base en evidencia",
      ],
    },
    {
      title: "Programas Modulares",
      subtitle: "Flexibilidad por areas",
      accentColor: "#685599",
      accentColorLight: "#8a78b8",
      accentGlow:
        "radial-gradient(circle, rgba(104, 85, 153, 0.15), transparent 70%)",
      features: [
        "Implementacion por areas tematicas o niveles educativos",
        "Ajuste por objetivos y presupuesto institucional",
        "Modulos adaptados a necesidades especificas",
        "Ruta por etapas para avanzar a tu ritmo",
        "Continuidad simple hacia programas mas amplios",
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-[var(--text-secondary)] max-w-2xl mx-auto leading-relaxed">
            Inicia con un piloto, escala a un programa anual o trabaja por
            modulos segun tus objetivos y presupuesto.
          </p>
        </div>
