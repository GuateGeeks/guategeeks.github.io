    ...
    <section id="nosotros" className="py-12 sm:py-16 bg-[var(--bg-secondary)] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base text-soft-gray font-semibold tracking-wide uppercase">Sobre Nosotros</h2>
        ...
        <div className="mt-10 bg-[var(--bg-card)] rounded-lg shadow-lg p-6 sm:p-8 border-l-8 border-soft-gray transition-colors duration-300">
