...
const BenefitItem = ({ icon, title, description, delay }) => (
  ...
  >
    <div className="flex-shrink-0">
      ...
      >
        <svg className="h-6 w-6 text-royal-violet" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={icon} />
        </svg>
      </div>
    </div>
    <div>
      <h4 className="text-base font-semibold text-[var(--text-primary)] mb-1 tracking-tight">{title}</h4>
  ...
  const benefits = [
    {
      ...
      title: "Metodologia Propia",
      description: "Contenido adaptado al contexto local y alineado a estandares internacionales.",
    },
    {
      icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4",
      title: "Soporte Local",
      description: "Respuesta rapida y tecnica presencial en Guatemala.",
    },
    {
      icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6",
      title: "Resultados Medibles",
      description: "Evaluamos el progreso de estudiantes y docentes con metricas claras.",
    },
  ];
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-[var(--text-secondary)] leading-relaxed">
              No solo vendemos tecnologia, garantizamos que se utilice para potenciar el aprendizaje.
            </p>
            ...
            <div className="relative glass-card overflow-hidden">
              ...
              <div className="relative aspect-[16/10] overflow-hidden rounded-t-[20px]" style={{
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full">
                  ...
                  <p className="text-royal-violet-800 text-sm mt-1 font-medium">Innovacion & Aprendizaje</p>
                </div>

                {/* Decorative dots */}
                <div className="absolute top-6 right-8 w-2 h-2 bg-blue-700 rounded-full animate-pulse" />
                <div className="absolute bottom-8 left-10 w-2 h-2 bg-emerald rounded-full animate-bounce" style={{ animationDuration: '2s' }} />
              </div>
              ...
              <div className="p-6">
                <blockquote>
                  <p className="text-base text-[var(--text-primary)] italic leading-relaxed">
                    "La implementacion de GuateGeeks transformo la dinamica de nuestras clases. Los estudiantes ahora son creadores activos de tecnologia."
                  </p>
                </blockquote>
                <div className="mt-4 flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-[var(--text-primary)]">Lic. Maria Gonzalez</div>
                    <div className="text-xs text-royal-violet font-medium">Directora Academica</div>
                  </div>
                </div>
              </div>
            </div>
