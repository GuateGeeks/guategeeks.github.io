...
function App() {
  ...
  const animate = useCallback(() => {
    ...
    glass.style.maskImage = `radial-gradient(circle ${radius}px at ${sx}px ${sy}px, transparent 0%, transparent 35%, rgba(0,0,0,0.4) 55%, black 75%)`;
    glass.style.webkitMaskImage = `radial-gradient(circle ${radius}px at ${sx}px ${sy}px, transparent 0%, transparent 35%, rgba(0,0,0,0.4) 55%, black 75%)`;
